...
import useAdminAccess from "../../../../hooks/adminPanel/useAdminAccess";



const CreateProductForm = ({ setShow }: CreateProductFormProps) => {

    const access = useAdminAccess("create_product")
        ...
        <>
            {
                access.length > 0
                    ...
                    : <div className="p-5"><span>اجازه ی ایجاد محصول ندارید.</span></div>
            }
        </>
    )
}
