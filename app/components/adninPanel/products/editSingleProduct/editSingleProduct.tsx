...
import { useUpdateProductForm } from "../../../../hooks/adminPanel/products/useUpdateProductForm"
import { validationSchema } from "../createProductForm/verifyForm.config"
import { useRouter } from "next/router"


export const EditSingleProduct = ({ data , productid }) => {

    const router = useRouter()
    const { updateProductFormHandler } = useUpdateProductForm(productid)
                    ...
                    <Form className="admin-panel-layout">
                        ...
                        <div className="p-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center">
                            ...
                            <button type="button"
                                ...
                                onClick={() => {router.push("/admin/products") }}>انصراف</button>
                        </div>
                    </Form>
                )}
            </Formik>
